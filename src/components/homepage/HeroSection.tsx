        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start" style={{ minHeight: 'calc(80vh - 400px)' }}>
          ...
          <div className="text-white">
            <h1 className="text-5xl md:text-6xl mb-8 leading-tight">
              <span className="block">New Frontier</span>
          ...
          <div className="relative h-full flex items-end justify-end lg:justify-end lg:pl-32" style={{ transform: 'translateY(-40px)' }}>
            <div className="relative z-50 w-full flex justify-end">
              <img 
                src="/lovable-uploads/61c3f405-c372-43ea-a6e7-a12bcd703981.png" 
                alt="Professional woman with laptop" 
                className="w-full max-w-lg ml-auto lg:ml-80 object-contain"
        ...
        <div className="bg-gray-900 text-white py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl md:text-4xl mb-4">
              Onboarding and Continuous Education <span style={{ color: '#FFDA00' }}>Courses</span>
            </h2>
          </div>
        </div>
      </div>
