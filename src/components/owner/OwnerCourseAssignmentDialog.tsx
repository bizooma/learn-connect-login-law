...
interface OwnerCourseAssignmentDialogProps {
  open: boolean;
...
const OwnerCourseAssignmentDialog = ({ open, onOpenChange, onAssignCourse, lawFirmId }: OwnerCourseAssignmentDialogProps) => {
      ...
      <DialogContent className="max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end space-x-2">
            ...
            <Button 
              type="submit" 
              disabled={loading || !selectedUserId || !selectedCourseId || employeesLoading}
            >
...
export default OwnerCourseAssignmentDialog;