  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        content: "To remove a student from a law firm, deactivate their account through User Management → Users. When you deactivate a user who belongs to a law firm, the system automatically: removes their law firm association (clears law_firm_id), frees up one seat (decrements used_seats), logs the action in the audit trail, and preserves their user account, course progress, and certificates. The user will no longer have access to law firm-specific calendar events. If you restore the user later, they will NOT be automatically re-assigned to their previous law firm - you must manually add them back. Important: Deactivation is a soft delete that can be reversed. To permanently delete a user account, contact a system administrator. Course assignments remain unless explicitly removed separately. Monitor seat utilization (used_seats/total_seats) in the Law Firm dashboard to track available seats."
      },
      {
