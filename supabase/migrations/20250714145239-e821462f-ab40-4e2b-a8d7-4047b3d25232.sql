...
BEGIN
    ...
    LOOP
        RAISE NOTICE 'Processing course: % (ID: %)', v_course_record.course_title, v_course_record.course_id;
        ...
        RAISE NOTICE 'Course stats - Total units: %, Completed: %, Progress: %%, Status: %', 
...
EXCEPTION WHEN OTHERS THEN
    RAISE EXCEPTION 'Data restoration failed: % (SQLSTATE: %)', SQLERRM, SQLSTATE;
END $$;